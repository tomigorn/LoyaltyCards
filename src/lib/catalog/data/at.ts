...
export const AT: CatalogEntry[] = [
  ...
  { id: 'at-billa', name: 'Billa', aliases: ['billa plus', 'billa club', 'billa card'], domain: 'billa.at', country: 'AT', defaultFormat: 'ean13', brandColor: '#FFD700' },
  ...
  { id: 'at-lidl', name: 'Lidl Österreich', aliases: ['lidl', 'lidl plus', 'lidl at'], domain: 'lidl.at', country: 'AT', defaultFormat: 'ean13', brandColor: '#0050AA' },
  { id: 'at-merkur', name: 'Merkur', aliases: ['merkur markt'], domain: 'merkurmarkt.at', country: 'AT', defaultFormat: 'ean13', brandColor: '#CC071E' },
  ...
  { id: 'at-dm', name: 'dm Österreich', aliases: ['dm drogerie', 'dm aktiv plus', 'dm austria'], domain: 'dm.at', country: 'AT', defaultFormat: 'ean13', brandColor: '#EF7C00' },
  { id: 'at-bipa', name: 'Bipa', aliases: ['bipa card', 'bipa drogerie'], domain: 'bipa.com', country: 'AT', defaultFormat: 'ean13', brandColor: '#E2001A' },
  ...
  { id: 'at-shell', name: 'Shell', aliases: ['shell station', 'shell clubsmart'], domain: 'shell.at', country: 'AT', defaultFormat: 'ean13' },
  ...
  // Fashion / Clothing
  { id: 'at-h-m', name: 'H&M', aliases: ['h and m', 'hm', 'hm member'], domain: 'hm.com', country: 'AT', defaultFormat: 'code128' },
  ...
  // DIY / Home
  { id: 'at-ikea', name: 'IKEA', aliases: ['ikea family', 'ikea oesterreich'], domain: 'ikea.com', country: 'AT', defaultFormat: 'code128', brandColor: '#0058A3' },
  ...
  // Travel / Airlines
  { id: 'at-austrian', name: 'Austrian Airlines', aliases: ['austrian', 'miles and more', 'aua'], domain: 'austrian.com', country: 'AT', defaultFormat: 'aztec', brandColor: '#CC071E' },
  { id: 'at-oebb', name: 'ÖBB', aliases: ['obb', 'oebb', 'vorteilscard'], domain: 'oebb.at', country: 'AT', defaultFormat: 'aztec', brandColor: '#CC071E' },
  ...
  // Coffee / Food
  { id: 'at-starbucks', name: 'Starbucks', aliases: ['starbucks rewards'], domain: 'starbucks.at', country: 'AT', defaultFormat: 'qr', brandColor: '#006241' },
  { id: 'at-mcdonalds', name: "McDonald's", aliases: ['mcdonald', 'mcdonalds rewards'], domain: 'mcdonalds.at', country: 'AT', defaultFormat: 'qr' },
];
