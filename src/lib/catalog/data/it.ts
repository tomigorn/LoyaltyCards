...
export const IT: CatalogEntry[] = [
  ...
  { id: 'it-lidl', name: 'Lidl Italia', program: 'Plus', aliases: ['lidl', 'lidl plus', 'lidl it'], domain: 'lidl.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#0050AA' },
  ...
  { id: 'it-md', name: 'MD', aliases: ['md discount'], domain: 'mdspa.it', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-crai', name: 'Crai', aliases: ['crai supermercati'], domain: 'crai-supermercati.it', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-tigros', name: 'Tigros', aliases: ['tigros card'], domain: 'tigros.it', country: 'IT', defaultFormat: 'ean13' },
  ...
  { id: 'it-sephora', name: 'Sephora', program: 'Beauty Insider', aliases: ['sephora beauty pass'], domain: 'sephora.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#000000' },
  { id: 'it-tigota', name: 'Tigotà', aliases: ['tigota card'], domain: 'tigota.it', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-douglas', name: 'Douglas', program: 'Beauty Card', aliases: ['douglas beauty card', 'limoni', 'profumeria douglas'], domain: 'douglas.it', country: 'IT', defaultFormat: 'ean13' },
  ...
  { id: 'it-q8', name: 'Q8', program: 'Club Q8', aliases: ['q8 kuwait', 'club q8'], domain: 'q8.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#009640' },
  ...
  { id: 'it-calzedonia', name: 'Calzedonia', aliases: ['calzedonia card'], domain: 'calzedonia.com', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-intimissimi', name: 'Intimissimi', aliases: ['intimissimi card'], domain: 'intimissimi.com', country: 'IT', defaultFormat: 'ean13' },
  ...
  // DIY / Home
  { id: 'it-ikea', name: 'IKEA', program: 'Family', aliases: ['ikea family', 'ikea italia'], domain: 'ikea.com', country: 'IT', defaultFormat: 'code128', brandColor: '#0058A3' },
  ...
  { id: 'it-mondo-convenienza', name: 'Mondo Convenienza', aliases: ['mondo convenienza mobili'], domain: 'mondoconv.it', country: 'IT', defaultFormat: 'ean13' },

  // Sports / Outdoor
  { id: 'it-decathlon', name: 'Decathlon', aliases: ['decathlon italia'], domain: 'decathlon.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#0082C3' },
  { id: 'it-cisalfa', name: 'Cisalfa Sport', aliases: ['cisalfa'], domain: 'cisalfasport.it', country: 'IT', defaultFormat: 'ean13' },

  // Books / Stationery
  { id: 'it-feltrinelli', name: 'laFeltrinelli', aliases: ['feltrinelli', 'la feltrinelli'], domain: 'lafeltrinelli.it', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-mondadori', name: 'Mondadori Store', aliases: ['mondadori'], domain: 'mondadoristore.it', country: 'IT', defaultFormat: 'ean13' },

  // Pet
  { id: 'it-arcaplanet', name: 'Arcaplanet', aliases: ['arcaplanet card'], domain: 'arcaplanet.it', country: 'IT', defaultFormat: 'ean13' },
