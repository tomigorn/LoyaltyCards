...
export const IT: CatalogEntry[] = [
  ...
  { id: 'it-esselunga', name: 'Esselunga', aliases: ['fidelity esselunga', 'carta fidelity'], domain: 'esselunga.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#E2001A' },
  { id: 'it-conad', name: 'Conad', aliases: ['conad card', 'conad societa cooperativa'], domain: 'conad.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#E2001A' },
  ...
  { id: 'it-lidl', name: 'Lidl Italia', aliases: ['lidl', 'lidl plus', 'lidl it'], domain: 'lidl.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#0050AA' },
  ...
  { id: 'it-sephora', name: 'Sephora', aliases: ['sephora beauty pass'], domain: 'sephora.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#000000' },

  // Fuel
  { id: 'it-eni', name: 'Eni', aliases: ['eni station', 'eni rewards', 'enilive'], domain: 'eni.com', country: 'IT', defaultFormat: 'ean13', brandColor: '#FFCC00' },
  ...
  { id: 'it-shell', name: 'Shell', aliases: ['shell station', 'shell clubsmart'], domain: 'shell.it', country: 'IT', defaultFormat: 'ean13' },
  { id: 'it-ip', name: 'IP', aliases: ['ip energie', 'ip stazione'], domain: 'ip-energia.it', country: 'IT', defaultFormat: 'ean13' },

  // Fashion / Clothing
  { id: 'it-h-m', name: 'H&M', aliases: ['h and m', 'hm', 'hm member'], domain: 'hm.com', country: 'IT', defaultFormat: 'code128' },
  { id: 'it-zara', name: 'Zara', aliases: ['zara italia'], domain: 'zara.com', country: 'IT', defaultFormat: 'code128' },
  { id: 'it-ovs', name: 'OVS', aliases: ['ovs club', 'oviesse'], domain: 'ovs.it', country: 'IT', defaultFormat: 'ean13', brandColor: '#E2001A' },
  ...
  // DIY / Home
  { id: 'it-ikea', name: 'IKEA', aliases: ['ikea family', 'ikea italia'], domain: 'ikea.com', country: 'IT', defaultFormat: 'code128', brandColor: '#0058A3' },
  ...
  // Travel / Airlines
  { id: 'it-ita-airways', name: 'ITA Airways', aliases: ['ita', 'volare', 'alitalia'], domain: 'ita-airways.com', country: 'IT', defaultFormat: 'aztec', brandColor: '#002E5D' },
  { id: 'it-trenitalia', name: 'Trenitalia', aliases: ['trenitalia cartafreccia', 'cartafreccia'], domain: 'trenitalia.com', country: 'IT', defaultFormat: 'aztec', brandColor: '#CC071E' },

  // Coffee / Food
  { id: 'it-starbucks', name: 'Starbucks', aliases: ['starbucks rewards'], domain: 'starbucks.it', country: 'IT', defaultFormat: 'qr', brandColor: '#006241' },
  { id: 'it-mcdonalds', name: "McDonald's", aliases: ['mcdonald', 'mcdonalds rewards'], domain: 'mcdonalds.it', country: 'IT', defaultFormat: 'qr' },
];
