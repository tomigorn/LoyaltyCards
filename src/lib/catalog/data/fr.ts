...
export const FR: CatalogEntry[] = [
  ...
  { id: 'fr-leclerc', name: 'E.Leclerc', program: 'Carte E.Leclerc', aliases: ['leclerc', 'carte e leclerc', 'mouvement leclerc'], domain: 'leclerc.com', country: 'FR', defaultFormat: 'ean13', brandColor: '#003DA5' },
