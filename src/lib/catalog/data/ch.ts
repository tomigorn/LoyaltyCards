...
export const CH: CatalogEntry[] = [
  ...
  { id: 'ch-migros', name: 'Migros', aliases: ['cumulus', 'cumulus card'], domain: 'migros.ch', country: 'CH', defaultFormat: 'ean13', brandColor: '#FF6600' },
  { id: 'ch-coop', name: 'Coop', aliases: ['supercard', 'coop city', 'coop supercard'], domain: 'coop.ch', country: 'CH', defaultFormat: 'ean13', brandColor: '#E2001A' },
  ...
  { id: 'ch-lidl', name: 'Lidl Schweiz', aliases: ['lidl', 'lidl ch', 'lidl plus'], domain: 'lidl.ch', country: 'CH', defaultFormat: 'ean13', brandColor: '#0050AA' },
  { id: 'ch-volg', name: 'Volg', aliases: ['topcard volg'], domain: 'volg.ch', country: 'CH', defaultFormat: 'ean13' },
  ...
  // Fuel / Mobility
  { id: 'ch-shell', name: 'Shell', aliases: ['shell clubsmart'], domain: 'shell.ch', country: 'CH', defaultFormat: 'ean13' },
  ...
  { id: 'ch-h-m', name: 'H&M', aliases: ['h and m', 'hm member'], domain: 'hm.com', country: 'CH', defaultFormat: 'code128' },
  ...
  // DIY / Home
  { id: 'ch-ikea', name: 'IKEA', aliases: ['ikea family', 'ikea schweiz'], domain: 'ikea.com', country: 'CH', defaultFormat: 'code128', brandColor: '#0058A3' },
  ...
  // Travel / Transport
  { id: 'ch-sbb', name: 'SBB', aliases: ['cff', 'ffs', 'swisspass', 'swiss pass'], domain: 'sbb.ch', country: 'CH', defaultFormat: 'aztec' },
  { id: 'ch-swiss', name: 'SWISS', aliases: ['swiss airlines', 'swiss miles more', 'miles and more'], domain: 'swiss.com', country: 'CH', defaultFormat: 'aztec', brandColor: '#B41E21' },
  ...
  { id: 'ch-starbucks', name: 'Starbucks', aliases: ['starbucks rewards'], domain: 'starbucks.com', country: 'CH', defaultFormat: 'qr', brandColor: '#006241' },
  { id: 'ch-mcdonalds', name: "McDonald's", aliases: ['mcdonald', 'mymarcos', 'mcdonalds'], domain: 'mcdonalds.ch', country: 'CH', defaultFormat: 'qr' },
