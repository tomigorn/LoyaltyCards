...
export interface RemoteCardData {
  ...
  frontPhotoRef: string; backPhotoRef: string; logoBlobRef: string;
...
export function toRemote(card: Card, owner: string): RemoteCardData {
  return {
    ...
    frontPhotoRef: card.frontPhotoRef ?? '', backPhotoRef: card.backPhotoRef ?? '', logoBlobRef: card.logo.blobRef ?? '',
...
export function fromRemote(r: RemoteCardData | (Partial<RemoteCardData> & Record<string, unknown>)): Card {
  return {
    ...
    logo: {
      source: (r.logoSource as LogoSource) || 'generated',
      url: r.logoUrl ? String(r.logoUrl) : undefined,
      blobRef: r.logoBlobRef ? String(r.logoBlobRef) : undefined,
    },
    ...
    frontPhotoRef: r.frontPhotoRef ? String(r.frontPhotoRef) : undefined,
    backPhotoRef: r.backPhotoRef ? String(r.backPhotoRef) : undefined,
  };
}
